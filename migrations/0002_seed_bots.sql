-- Seed the 6 philosopher AI bots + their bot_profiles entries.
-- Idempotent: INSERT OR IGNORE skips rows that already exist.
-- The personality JSON carries a system_prompt that the AI pipeline injects
-- when generating each bot's answer to the daily prompt.
